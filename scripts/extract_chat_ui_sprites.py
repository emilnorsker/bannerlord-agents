...
COMPONENT_SPRITES = {
    ...
    "middle_panel_background": [
        ...
        "StdAssets\\standart_popup",
        "StdAssets\\panel_background",
        "StdAssets\\flat_panel",
        "StdAssets\\flat_panel_texture",
        "StdAssets\\panel_dent",
        "StdAssets\\Popup\\order_popup_canvas",
        "SPGeneral\\Frame1.Broken\\canvas",
        "SPGeneral\\Frame1\\canvas",
        "SPGeneral\\EscapeMenu\\escape_panel",
        "SPGeneral\\EscapeMenu\\esc_menu_frame_canvas",
        "SPGeneral\\GameMenu\\panel_frame",
        "SPGeneral\\GameMenu\\troop_selection_panel",
        "SPGeneral\\SPScoreboard\\tournament_canvas",
        "SPGeneral\\Tutorial\\tutorial_canvas",
        "General\\CharacterCreation\\character_creation_panel",
        "General\\InnerFrame1\\canvas",
        "CharacterDeveloper\\AttributePopup\\attribute_popup_canvas",
        "CharacterDeveloper\\character_progress_panel",
        "CharacterDeveloper\\left_panel_coverup",
        "CharacterDeveloper\\left_panel_stone",
        "button_canvas",
        "rounded_canvas",
        "Barter\\barter_panel",
        "Conversation\\npc_dialogue_panel",
        "Quest\\background_quest",
        "Quest\\big_canvas",
    ],
    "message_separator": [
