...
public class MainAgentHUD__TaleWorlds_MountAndBlade_ViewModelCollection_MissionAgentStatusVM_Dependency_5_ItemTemplate : DisabledAlphaChangerWidget
{
	private DisabledAlphaChangerWidget _widget;

	private RichTextWidget _widget_0;

	private MissionInteractionItemBaseVM _datasource_Root;
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	public void SetDataSource(MissionInteractionItemBaseVM dataSource)
	{
		throw null;
	}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	private void RefreshDataSource_datasource_Root(MissionInteractionItemBaseVM newDataSource)
	{
		throw null;
	}
}
