...
public class EducationOptionVM : StringItemWithActionVM
{
	...
	public EducationCampaignBehavior.EducationCharacterProperties[] CharacterProperties
	{
		[MethodImpl(MethodImplOptions.NoInlining)]
		[CompilerGenerated]
		get
	...
	public (CharacterAttribute, int)[] OptionAttributes
	{
		[MethodImpl(MethodImplOptions.NoInlining)]
		[CompilerGenerated]
		get
	...
	public (SkillObject, int)[] OptionSkills
	{
		[MethodImpl(MethodImplOptions.NoInlining)]
		[CompilerGenerated]
		get
	...
	public (SkillObject, int)[] OptionFocusPoints
	{
		[MethodImpl(MethodImplOptions.NoInlining)]
		[CompilerGenerated]
		get
