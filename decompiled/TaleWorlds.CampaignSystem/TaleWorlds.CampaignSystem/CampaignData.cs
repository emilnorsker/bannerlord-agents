...
public static class CampaignData
{
	...
	public static readonly uint[] EmpireHeroClothColors;

	public static readonly uint[] SturgiaHeroClothColors;

	public static readonly uint[] AseraiHeroClothColors;

	public static readonly uint[] VlandiaHeroClothColors;

	public static readonly uint[] BattaniaHeroClothColors;

	public static readonly uint[] KhuzaitHeroClothColors;
