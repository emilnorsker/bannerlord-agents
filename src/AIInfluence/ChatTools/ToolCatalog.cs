	...
	public static JArray GetToolsForApi()
	{
		return new JArray
		{
			...
			Tool("transfer_items", "Transfers items between this character and the player. Each row: item_id, amount, action give or take. opposed_attribute at top level is optional for a contested transfer.",
				"{\"items\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{\"item_id\":{\"type\":\"string\"},\"amount\":{\"type\":\"integer\"},\"action\":{\"type\":\"string\",\"enum\":[\"give\",\"take\"]}},\"required\":[\"item_id\",\"amount\",\"action\"]}},\"opposed_attribute\":{\"type\":\"string\"}}", new[] { "items" }),
			...
			Tool("kingdom_action", "Kingdom-level diplomatic action. Some action values require settlement_id from find_settlements.",
				"{\"action\":{\"type\":\"string\"},\"reason\":{\"type\":\"string\"},\"settlement_id\":{\"type\":\"string\"}}", new[] { "action", "reason" }),
			Tool("create_quest", "Creates a new quest for the player. Only one active quest per NPC.",
				"{\"title\":{\"type\":\"string\"},\"description\":{\"type\":\"string\",\"description\":\"Player-facing quest journal text. Plain prose, no JSON or string_ids.\"},\"category\":{\"type\":\"string\",\"enum\":[\"Combat\",\"Negotiation\",\"Intrigue\",\"Escort\",\"Gather\",\"Other\"]},\"reward_gold\":{\"type\":\"integer\"},\"duration_days\":{\"type\":\"integer\",\"description\":\"7-120.\"},\"target_npc_ids\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}},\"completer_npc_id\":{\"type\":\"string\"},\"ai_verification_notes\":{\"type\":\"string\",\"description\":\"Private AI-only notes for quest verification.\"},\"progress_target\":{\"type\":\"integer\"},\"progress_label\":{\"type\":\"string\"},\"reward_items\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{\"item_name\":{\"type\":\"string\"},\"count\":{\"type\":\"integer\"}},\"required\":[\"item_name\",\"count\"]}},\"reward_skill\":{\"type\":\"string\"},\"reward_skill_xp\":{\"type\":\"integer\"},\"crime_rating_change\":{\"type\":\"integer\"},\"influence_change\":{\"type\":\"integer\"},\"spawn_party\":{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\",\"description\":\"NPC name. Creates a named hero. Omit for leaderless party.\"},\"alignment\":{\"type\":\"string\",\"enum\":[\"friendly\",\"hostile\",\"neutral\"]},\"culture\":{\"type\":\"string\"},\"backstory\":{\"type\":\"string\"},\"personality\":{\"type\":\"string\"},\"is_female\":{\"type\":\"boolean\"},\"age\":{\"type\":\"integer\"},\"settlement\":{\"type\":\"string\",\"description\":\"Town/village name to spawn near.\"},\"party_name\":{\"type\":\"string\",\"description\":\"Map party display name.\"},\"party_troops\":{\"type\":\"array\",\"items\":{\"type\":\"string\"},\"description\":\"Troop type names, fuzzy-matched.\"},\"party_size\":{\"type\":\"integer\",\"description\":\"Total troops. 0 = NPC alone.\"}},\"required\":[\"alignment\"]}}", new[] { "title", "description", "category" }),
			Tool("update_quest", "Updates an active quest: add log entry, change progress, or attach a spawn_party.",
				"{\"quest_id\":{\"type\":\"string\"},\"update_log\":{\"type\":\"string\"},\"set_progress\":{\"type\":\"integer\"},\"spawn_party\":{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\",\"description\":\"NPC name. Creates a named hero. Omit for leaderless party.\"},\"alignment\":{\"type\":\"string\",\"enum\":[\"friendly\",\"hostile\",\"neutral\"]},\"culture\":{\"type\":\"string\"},\"backstory\":{\"type\":\"string\"},\"personality\":{\"type\":\"string\"},\"is_female\":{\"type\":\"boolean\"},\"age\":{\"type\":\"integer\"},\"settlement\":{\"type\":\"string\",\"description\":\"Town/village name to spawn near.\"},\"party_name\":{\"type\":\"string\",\"description\":\"Map party display name.\"},\"party_troops\":{\"type\":\"array\",\"items\":{\"type\":\"string\"},\"description\":\"Troop type names, fuzzy-matched.\"},\"party_size\":{\"type\":\"integer\",\"description\":\"Total troops. 0 = NPC alone.\"}},\"required\":[\"alignment\"]}}", new[] { "quest_id" }),
			Tool("complete_quest", "Completes an active quest successfully, awarding rewards.",
				"{\"quest_id\":{\"type\":\"string\"},\"completion_reason\":{\"type\":\"string\"}}", new[] { "quest_id", "completion_reason" }),
			Tool("fail_quest", "Fails an active quest.",
				"{\"quest_id\":{\"type\":\"string\"},\"completion_reason\":{\"type\":\"string\"}}", new[] { "quest_id", "completion_reason" }),
