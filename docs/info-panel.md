...
| 5 | World events      | Recent dynamic events (`GlyphLines`): icon from `DynamicEvent.Type` (political/military/economic/local/rumor/news/social, etc. → `DefaultSkills`). Section header icon: Scouting. “None” uses `TextLines`. |
